            ...
            <div className="w-full max-w-md rounded-[30px] border border-sky-200/80 bg-white/72 p-8 shadow-[0_25px_80px_rgba(125,211,252,0.18)] backdrop-blur-xl">
              ...
              <form className="space-y-5">
                ...
                <div className="flex items-center gap-4 pt-3">
                  <button
                    type="submit"
                    className="inline-flex min-w-28 items-center justify-center rounded-full border border-sky-300 bg-sky-100 px-6 py-3 text-sm font-medium text-sky-800 transition hover:bg-sky-200 hover:text-sky-900 hover:shadow-[0_12px_24px_rgba(125,211,252,0.28)]"
                  >
                    Login
                  </button>
